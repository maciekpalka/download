...
echo %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% %text% >>c:\Users\%USERNAME%\Desktop\Windows\%haslo%.lua
exit